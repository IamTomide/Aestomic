        ...
        <div className="flex flex-col lg:flex-row lg:gap-16 max-w-7xl mx-auto px-5 lg:px-8 pt-10 pb-14 md:pt-20 md:pb-24 lg:items-center">
            ...
            <div className="relative lg:max-w-xl mt-16 lg:col-span-6 aspect-video">
                <div className="relative rounded-3xl shadow-2xl ring-1 ring-border">
                    <img src={HeroImg} alt="School Image" width={1536} height={1024} className="w-full as h-full object-cover rounded-3xl aspect-video" fetchPriority="high" loading="eager" />
